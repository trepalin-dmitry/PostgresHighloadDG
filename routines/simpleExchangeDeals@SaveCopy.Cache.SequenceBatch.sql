create or replace procedure "simpleExchangeDeals@SaveCopy.Cache.SequenceBatch"(size integer)
	language plpgsql
as $$
begin
...
alter procedure "simpleExchangeDeals@SaveCopy.Cache.SequenceBatch"(integer) owner to postgres;
