create or replace procedure "simpleExchangeDeals@Save.Database.Identity"(data character varying, size integer)
	language plpgsql
as $$
begin
    INSERT INTO "simpleExchangeDealsIdentity" (guid, "accountGUId", "couponCurrencyGUId", "couponVolume",
                                               "currencyGUId",
                                               "dealDateTime",
...
alter procedure "simpleExchangeDeals@Save.Database.Identity"(varchar, integer) owner to postgres;
