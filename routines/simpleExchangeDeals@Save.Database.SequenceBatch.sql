create or replace procedure "simpleExchangeDeals@Save.Database.SequenceBatch"(data character varying, size integer)
	language plpgsql
as $$
begin
...
alter procedure "simpleExchangeDeals@Save.Database.SequenceBatch"(varchar, integer) owner to postgres;
