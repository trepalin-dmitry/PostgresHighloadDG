create or replace procedure "exchangeDeals@Save.Cache.SequenceBatch"(data character varying, size integer)
	language plpgsql
as $$
DECLARE
    dealsIds bigint[];
...
alter procedure "exchangeDeals@Save.Cache.SequenceBatch"(varchar, integer) owner to postgres;
