create or replace procedure "exchangeDeals@Save.Cache.SequenceOne"(data character varying, size integer)
	language plpgsql
as $$
DECLARE
    dealsIds bigint[];
...
alter procedure "exchangeDeals@Save.Cache.SequenceOne"(varchar, integer) owner to postgres;
