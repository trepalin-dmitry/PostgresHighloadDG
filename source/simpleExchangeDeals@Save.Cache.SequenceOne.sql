create or replace procedure "simpleExchangeDeals@Save.Cache.SequenceOne"(data character varying, size integer)
	language plpgsql
as $$
begin
...
alter procedure "simpleExchangeDeals@Save.Cache.SequenceOne"(varchar, integer) owner to postgres;
