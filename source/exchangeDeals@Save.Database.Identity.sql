create or replace procedure "exchangeDeals@Save.Database.Identity"(data character varying, size integer)
	language plpgsql
as $$
DECLARE
    dealsIds bigint[];
...
alter procedure "exchangeDeals@Save.Database.Identity"(varchar, integer) owner to postgres;
